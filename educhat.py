# smart tutor, Streamlit app by Harshal Soni, March 2025
...
st.subheader("SmartTutor: Your Personalized AI Tutor")
st.markdown("""This AI tutor chatbot is designed to help you **learn actively**, not just get answers. 
            Instead of giving direct solutions, it **guides you with hints and suggestions**, encouraging deeper understanding. 
            Whether you're stuck on a math problem or exploring new topics, 
            this tool is built to support your learning journey step-by-step 
            — like a real tutor, not a shortcut machine!

            """)

@st.dialog("Welcome to SmartTutor!")
def dialog():
    st.write(
        "SmartTutor is now live on the Streamlit Community Cloud. "
        "This platform provides a free and seamless experience for learners to get guided help from AI."
    )
    st.write(
        "This chatbot is designed to help you learn by giving hints and step-by-step guidance, "
        "rather than directly giving answers. "
        "Feel free to explore and use it to boost your understanding!"
    )
    st.write(
        "Built with ❤️ by [Harshal Soni](https://github.com/your-github-username). "
        "Fork the [GitHub Repo](https://github.com/your-github-username/SmartTutor) and deploy your own!"
    )
...
if not st.session_state.model_set:  # Select model
    ...
    st.session_state.model_name = st.segmented_control(
    "Select any of these free models:", 
